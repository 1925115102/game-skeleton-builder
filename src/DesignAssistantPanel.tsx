...
export default function DesignAssistantPanel({ analysis, changeSet, loading, error, onRequestChange, onApprove, onReject, onClose }: Props) {
  return <div className="inspector">
    ...
    {changeSet ? <>
      ...
      <button style={buttonStyle} onClick={onApprove}>Approve Changes</button>
      <button style={buttonStyle} onClick={onReject}>Reject</button>
    </> : analysis && !loading && <>
